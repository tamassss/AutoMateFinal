...
export default function EditCar({ onClose, onSave, selectedCar }) {
  ...
  useEffect(function() {
    ...
    setLicensePlate(normalizeLicensePlateInput(selectedCar.license_plate || ""));
    
    // Fogyasztás
    const cons = selectedCar.average_consumption;
    setAverageCons(cons === null || cons === undefined ? "" : String(cons));
      ...
      >
        ...
        <div className="car-image-picker-wrap">
          ...
          <button
            ...
            onClick={function() { setShowImageSelect(true); }}
          >
            <img
